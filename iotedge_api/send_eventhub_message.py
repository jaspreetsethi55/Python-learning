...
EVENTHUB_NAME = "diag2state_devprd01_1500"
...
for i in range(ors):
    ...
    for j in range(devices):
        ...
        message_dict['syslog5424_host'] = device_id
        message_dict['orId'] = or_id
        message_dict['syslog5424_ts'] = current_timestamp

        message = json.dumps(message_dict)

        event_data_batch.add(EventData(message))
    producer.send_batch(event_data_batch)
print("sent 1500 records")
