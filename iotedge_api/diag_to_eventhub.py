...
test_d = '''{"syslog5424_app":"diagnostic","syslog5424_ver":"1","@version":"1","document_id":"1a2ca0dd081511d541190ed1b5e61d2617bcd979","syslog5424_host":"mna-240-enc-1234567-31","orId":"NOI-IN-WOW-3","syslog5424_ts":"2023-07-20T06: 04: 57.455+00: 00","@timestamp":"2023-07-20T06: 05: 06.927Z","ecs":{"version":"8.0.0"},"IP":"10.98.0.167","TIME":"2023-07-20T06: 00: 51.476+00: 00","log":{"offset":0,"file":{"path":"/var/log/nexxis-noi-in-jts-3-2023.07.20.log"}},"input":{"type":"log"},"etl_audit":[{"originating_kafka_topic":"nexxis-dev01-routing","processor":"log_router.py","processing_dt":"2023-07-20T06: 05: 09.361415"}],"syslog5424_msg_json":{"Interfaces":[{"ColorimetryMeasured":"sRGB","ColorimetryUser":"auto","Connected":"False","Format":"video","LinkStatus":{"BPC":0,"LaneCount":0,"LineRate":"20(HBR2)","LinkErrors":0,"Trained":"False","TrainingAttempts":0},"Name":"dpIn0","Resolution":"0x0p0","State":"OK","Stereo":"False","Syncs":"False","Type":"encoder"},{"ColorimetryMeasured":"sRGB","ColorimetryUser":"auto","Connected":"True","Format":"video","Name":"generator0","Resolution":"0x0p60000","State":"OK","Stereo":"False","Streams":[],"Syncs":"True","Type":"encoder"},{"Connected":"False","Format":"audio","Input":"line-in","Name":"audioIn","State":"OK","Type":"encoder"},{"Connected":"False","Format":"audio","HasLayout":"True","Name":"audioOut","Output":"line-out","State":"OK","Type":"decoder"},{"Connected":"False","Format":"usb","Name":"USBPeripherals","State":"OK","Type":"decoder"},{"Connected":"False","Format":"usb","Name":"USBHost","State":"OK","Type":"encoder"}],"Logserver":{"Condition":"AllmessagesOK","Messages":{"Dropped":0,"Processed":23447,"Queued":0,"Written":23447},"OperatingRoomId":"NOI-IN-JTS-3","ServerIpAddress":"10.99.113.9","ServerPort":"6514","State":"OK"},"Network":{"Interfaces":[{"IPAddress":"10.99.113.31","MACAddress":"b0: d5: cc: 79: 50: af","Name":"eth0","RxBytes(MB)":2234,"RxErrors":0,"RxPackets":11804860,"RxRate(kbps)":0,"SFP10GEthType":"10GBASE-SR","SFPConnectorType":"LC","SFPRevision":"G4.1","SFPRxPower(dBm)":-2.3711261870612079,"SFPSerial":"AD16323013Y","SFPTemperature(degr.C)":61,"SFPTxPower(dBm)":-2.6312563835157749,"SFPVendor":"AVAGO","SFPVoltage(V)":3.325,"State":"OK","TxBytes(MB)":277,"TxPackets":1151409,"TxRate(kbps)":0,"UptimeAddress(s)":1690743,"UptimeLink(s)":1690743},{"IPAddress":"10.99.113.12","MACAddress":"b2: d5: cc: 79: 50: af","Name":"eth1","RxBytes(MB)":2282,"RxErrors":0,"RxPackets":10443375,"RxRate(kbps)":0,"SFP10GEthType":"10GBASE-SR","SFPConnectorType":"LC","SFPRevision":"G4.1","SFPRxPower(dBm)":-3.136318965269638,"SFPSerial":"AD163230139","SFPTemperature(degr.C)":62,"SFPTxPower(dBm)":-2.667224660674182,"SFPVendor":"AVAGO","SFPVoltage(V)":3.3218,"State":"OK","TxBytes(MB)":1,"TxPackets":28237,"TxRate(kbps)":0,"UptimeAddress(s)":1690743,"UptimeLink(s)":1690743}]},"RtspServer":{"Format":"streaming","Media":[],"Name":"rtspserver","RtspConnections":[],"RtspSessions":[],"State":"OK","Type":"streaming"},"System":{"BootCount":27,"CPUFanPWM(%)":34,"CPUFanSpeed(RPM)":4230,"CPULoad(%)":100,"CPUTemperature(degr.C)":90,"FPGAFanPWM(%)":34,"FPGAFanSpeed(RPM)":3450,"FPGATemperature(degr.C)":68,"FreeRAM(%)":89,"Name":"mna-240-enc-1234567-31","ProductPartNumber":"K9303078A","ProductSerialNumber":"2530080634","ProductionDate":"2016-11-15","SoftwareVersion":"2.5.2-12-g324bee9","State":"OK","UpTime(s)":1690751,"name":"System"},"XmppAgents":[{"Name":"xmppagent","Type":"edp","edpserver":"","errormessage":"","state":"OK","status":"disabled","xmpp_error":""}]}}'''
...
def get_topology_message():
    ...
    message = TOPOLOGY_MESSAGE.replace("timestamp", TIMESTAMP).replace("or_id", or_id).replace("nms_id", nms_id)
    ...
    for i in range(1,6):
        ...
        message = message.replace("timestamp", TIMESTAMP).replace(device_id, device_id_value).replace(guid_id, guid_value)
...
print(type(json.loads(test_d)))
def set_request_params(message):
   
    request_json = {
      "data": [
        {
          "message": json.loads(test_d)
          #"message": { 'a' : 1 }
          #"deviceId": "test-d2c"
        }
      ],
