...
def send_d2c_request(message_type,url):
    ...
    r = producer.send('test_diag', json_message)
    return r
...
KAFKA_HOST = ["b-1.nexxismsktst03.uhbz4s.c9.kafka.eu-west-1.amazonaws.com:9092", "b-2.nexxismsktst03.uhbz4s.c9.kafka.eu-west-1.amazonaws.com:9092", "b-3.nexxismsktst03.uhbz4s.c9.kafka.eu-west-1.amazonaws.com:9092"]
...
def access_rate_limited_api(count):
    resp = send_d2c_request(MESSAGE_TYPE, producer)
    return count,resp
